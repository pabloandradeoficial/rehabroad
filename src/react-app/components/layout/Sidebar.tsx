...
export default function Sidebar({ className, collapsed = false }: SidebarProps) {
  ...
  const userName = user?.google_user_data?.name || user?.email?.split("@")[0] || "Fisioterapeuta";
  ...
  return (
    <aside className={cn(
        ...
        <div className={cn(
          ...
          {user?.google_user_data?.picture ? (
            ...
            <div className={cn(
              ...
              <span className={cn("font-bold text-white", collapsed ? "text-xs" : "text-sm")}>{userInitials}</span>
            </div>
          )}
          {!collapsed && (
            <>
      ...
      <nav className={cn("flex-1 overflow-y-auto scrollbar-thin", collapsed ? "px-2" : "px-3")}>
        {!collapsed && (
          <div className="mb-2">
            <span className="px-3 text-[10px] font-semibold text-slate-500 uppercase tracking-wider">Menu Principal</span>
          </div>
        )}
        ...
        {!collapsed && (
          <div className="mt-6 mb-2">
            <span className="px-3 text-[10px] font-semibold text-slate-500 uppercase tracking-wider">Ferramentas IA</span>
          </div>
        )}
        ...
        {!collapsed && (
          <div className="mt-6 mb-2">
            <span className="px-3 text-[10px] font-semibold text-slate-500 uppercase tracking-wider">Suporte</span>
          </div>
        )}
        {collapsed && <div className="mt-4" />}
        <ul className="space-y-0.5">
      ...
      <div className={cn(collapsed ? "p-2" : "p-3")}>
        <NavLink to="/dashboard/plano" title={collapsed ? (isPremium ? "Plano Ativo" : "Seja Premium") : undefined}>
          <div className={cn(
